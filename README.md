...
Self-hosted AI workspace with local LLM inference, custom Web UI, RAG, fine-tuning pipeline, and chain-of-thought reasoning. Built from scratch on Ubuntu with CUDA.
